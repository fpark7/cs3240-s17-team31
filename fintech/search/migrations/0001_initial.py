# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2017-04-30 18:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_type', models.CharField(choices=[('Na', 'Company Name'), ('Lo', 'Company Location'), ('Co', 'Company Country'), ('Se', 'Company Sector'), ('Pr', 'Current Project(s)'), ('Cn', 'CEO Name'), ('In', 'Industry'), ('Cp', 'Current Projects')], max_length=3)),
            ],
        ),
    ]
